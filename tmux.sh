...
tmux send-keys -tsoitgoes:0.0 'cd journal/static/journal; ./node_modules/.bin/webpack --watch --progress' Enter
tmux send-keys -tsoitgoes:0.1 'cd journal/static/journal; watch -n 5 ./node_modules/.bin/node-sass scss -r -o dist/' Enter
