...
export const fetch = (moduleName, fetchFn) => (...args) => (dispatch) => {
...
export const fetchOne = (moduleName, fetchFn) => (...args) => (dispatch) => {
...
export const save = (moduleName, saveFn) => (...args) => (dispatch) => {
...
export const isFetching = (moduleName) => (state = false, action) => {
  switch (action.type) {
